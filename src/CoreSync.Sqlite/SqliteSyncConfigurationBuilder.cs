...
{
    /// <summary>
    /// Provides a fluent API for building a <see cref="SqliteSyncConfiguration"/> that defines which tables
    ...
    /// Example usage:
    /// <code>
    /// var config = new SqliteSyncConfigurationBuilder("Data Source=local.db")
    ///     .Table("Items")
    ...
    public class SqliteSyncConfigurationBuilder
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SqliteSyncConfigurationBuilder"/> class.
        /// </summary>
        /// <param name="connectionString">The SQLite connection string used to connect to the local database.</param>
        ...
        /// </summary>
        /// <param name="name">The name of the SQLite table to synchronize.</param>
        ...
        /// <summary>
        /// Builds the <see cref="SqliteSyncConfiguration"/> from the registered tables.
        /// </summary>
        /// <returns>A new <see cref="SqliteSyncConfiguration"/> instance.</returns>
